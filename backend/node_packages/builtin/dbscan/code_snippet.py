...
def get_snippet(params: dict, input_vars: dict, output_vars: dict, label: str):
    ...
    code = (
        ...
        f'_db = DBSCAN(eps={eps}, min_samples={min_samples}, metric="{metric}")\n'
        f'_labels = _db.fit_predict(_numeric)\n'
        f'{out_df} = {inp}.copy()\n'
        ...
        f'{out_fig} = px.scatter(_plot_df, x="PC1", y="PC2", color="cluster", title="DBSCAN Clustering")\n'
        f'{out_fig}.show()\n'
    )
    return imports, code
